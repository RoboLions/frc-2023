...
public class Arm {
    ...
    public Arm() {
        ...
        RobotMap.leftShoulderMotor.configPeakOutputReverse(-0.25, 10);
        ...
        RobotMap.rightShoulderMotor.configPeakOutputReverse(-0.25, 10);
        ...
        RobotMap.leftElbowMotor.configPeakOutputReverse(-0.3, 10);
        ...
        RobotMap.rightElbowMotor.configPeakOutputReverse(-0.3, 10);
