    ...
    public void init() {
        ...
        if (current_color == Constants.CLAW.CUBE_COLOR) {
            RobotMap.arm.moveArmPosition(
                ...
                Constants.MID_SCORE_CUBE.RIGHT_SHOULDER_POSITION, 
                Constants.MID_SCORE_CUBE.LEFT_ELBOW_POSITION,
                Constants.MID_SCORE_CUBE.RIGHT_ELBOW_POSITION
            );
            return;
        }
        ...
        if (current_color == Constants.CLAW.CONE_COLOR) {
            RobotMap.arm.moveArmPosition(
                Constants.MID_SCORE_CONE.LEFT_SHOULDER_POSITION, 
                Constants.MID_SCORE_CONE.RIGHT_SHOULDER_POSITION, 
                Constants.MID_SCORE_CONE.LEFT_ELBOW_POSITION,
                Constants.MID_SCORE_CONE.RIGHT_ELBOW_POSITION
            );
            return;
        }
    }
